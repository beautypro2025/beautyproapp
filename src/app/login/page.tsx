    ...
    <div className='w-full bg-gradient-to-br from-primary to-secondary px-4 py-8 md:py-12'>
      ...
      >
        ...
        <motion.div
          ...
          className="mb-6 flex items-center justify-center gap-2 rounded-lg bg-primary/5 p-2 text-sm"
        >
        ...
        <motion.form variants={itemVariants} onSubmit={handleSubmit} className='mt-8 space-y-6'>
          <motion.div variants={itemVariants}>
            ...
            <input
              ...
              className='w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm transition-colors duration-200 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary'
          ...
          <motion.div variants={itemVariants}>
            <button
              type='submit'
              disabled={loading}
              className='w-full rounded-lg bg-primary px-4 py-2.5 text-center text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70'
            >
              {loading ? (
